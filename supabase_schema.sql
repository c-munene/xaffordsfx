-- ============================================================
-- XAffordsFX – Complete Supabase Schema + RLS
...
-- 2. Tables (safe if they already exist – we recreate policies cleanly)
...
-- 3. Grants (required – this was causing "permission denied")
...
-- 5. Drop old policies (idempotent) then recreate
do $$
declare
  r record;
begin
  for r in (
    ...
    where schemaname = 'public'
      and tablename in ('profiles', 'accounts', 'trades')
  ) loop
...
-- 6. Auto-create profile + default Main Account on signup
...
-- 3. Open https://c-munene.github.io/xaffordsfx/ → Sign up → Log trades
